-- F13: align the existing approved-request executor with the documented BD capability.
...
BEGIN
  IF NOT public.has_any_role(_actor_id, ARRAY['system_admin','bd_manager']::public.app_role[]) THEN
    RAISE EXCEPTION 'System admin or BD manager execution authority required' USING ERRCODE = '42501';
  END IF;
