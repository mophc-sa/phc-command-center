...
export const strings = {
  ...
  label_expected_close: { en: "Expected close date", ar: "تاريخ الإغلاق المتوقّع" },
  label_win_probability: { en: "Win probability", ar: "احتمال الفوز" },
  label_probability_reason: { en: "Why (optional)", ar: "السبب (اختياري)" },
  probability_bad: { en: "Probability is a whole number from 0 to 100.", ar: "الاحتمال رقم صحيح من 0 إلى 100." },
  label_value_min: { en: "Estimated value — from", ar: "القيمة التقديرية — من" },
  label_value_max: { en: "Estimated value — to", ar: "القيمة التقديرية — إلى" },
  figures_saved: { en: "Saved", ar: "حُفِظ" },
  figures_bad_number: { en: "Enter a number, or leave the box empty.", ar: "أدخل رقمًا، أو اترك الخانة فارغة." },
