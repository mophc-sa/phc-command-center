// Phase 2 (system-redesign request): RFQ & JIH Board's full content, moved
// here verbatim from the retired /rfq-jih route so it can render as a tab
// inside the Quotations page instead of its own page. No behavior change —
// same queries, same dialogs, same JIH conversion gates. See
// src/routes/_authenticated/rfq-jih.tsx (now a redirect to /quotations).
