// Phase 2 (system-redesign request): Quotations' own content, extracted so
// it renders as one tab alongside RfqJihPanel and BoqPanel inside the
// unified /quotations page. No behavior change from the original page body.
