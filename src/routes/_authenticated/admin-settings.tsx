                    ...
                    <div className="flex shrink-0 items-center gap-2">
                      ...
                      <label className="flex items-center gap-1.5">
                        ...
                        <select
                          ...
                          className="rounded-md border border-border bg-surface px-2 py-1 text-xs text-foreground focus:border-amber/60 focus:outline-none focus:ring-1 focus:ring-amber/40 disabled:opacity-60"
                        >
                          {ALL_ROLES.map((r) => (
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-md border border-won/30 bg-won/10 px-2.5 py-1.5 text-xs font-medium text-won transition-colors hover:bg-won/[0.15] disabled:cursor-not-allowed disabled:opacity-60"
                      >
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 py-1.5 text-xs font-medium text-muted-foreground transition-colors hover:border-destructive/30 hover:bg-destructive/10 hover:text-destructive disabled:cursor-not-allowed disabled:opacity-60"
                      >
                        ...
                        <td className="px-2 py-2 text-center">
                          <div className="flex items-center justify-center gap-1.5">
                            {isSelf ? (
                              ...
                              <span className="text-xs text-muted-foreground">{t("admin_user_deleted")}</span>
                            ) : (
                              <>
                                {m.status === "active" ? (
                                  <button
                                ...
                                {isSystemAdmin(roles) ? (
                                  <button
                                    ...
                                    className="inline-flex items-center gap-1 rounded-md border border-destructive/30 bg-destructive/5 px-2 py-1 text-xs text-destructive transition-colors hover:bg-destructive/15"
                                  >
