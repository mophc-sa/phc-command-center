...
function ProjectDetail() {
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      {/* Cover photo */}
      <div className={coverUrlQ.data ? "group relative h-40 overflow-hidden rounded-xl border border-border/70 bg-surface sm:h-56" : "relative flex min-h-12 items-center justify-end"}>
        {coverUrlQ.data ? (
        ...
        actions={
          <div className="flex gap-2">
            ...
            {isManager && p.verification_status !== "verified" ? (
              ...
              >
                {lang === "ar" ? "اعتماد التحقق" : "Mark as verified"}
              </button>
            ) : null}
            <EmailComposeButton
