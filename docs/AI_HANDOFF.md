...
`main` @ الدمج `1f15bd8` (PR #163، مدموج ومنشور — كود + Cloudflare Worker + **Edge Functions `ai-orchestrator` (v27) و`sales-os-api` (v40) منشورتان فعليًا**، تحقَّقتُ عبر `supabase functions list` وfetch مباشر بلا auth يُرجع خطأ منظَّم لا انهيار). قبله PR #161/#160. لا مهمة نشطة معلَّقة حاليًا.
