...
`main` @ الدمج `49eda92` (PR #165، مدموج ومنشور — Cloudflare Worker فقط، لا migrations ولا تغيير بكود Edge Functions). قبله PR #163 (`1f15bd8`، Edge Functions `ai-orchestrator` v27 و`sales-os-api` v40 منشورتان). لا مهمة نشطة معلَّقة حاليًا.
