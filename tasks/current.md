...
## بند فعّال — نشر واجهة PR 314 (كود المشروع يتبع المندوب)

الترحيل مطبّق والأرقام الثلاثة أُعيد ترقيمها. النشر التجريبي متوقف لأن Preview URLs مطفأة في Cloudflare. لا تُعتمد الطلبات الثلاثة المفتوحة قبل نشر الواجهة. التفاصيل أعلى `docs/AI_HANDOFF.md`.

## بند مؤجَّل — البريد عبر Postmark (2026-09-14، بانتظار موافقة Postmark)

الإرسال يعمل ويُسجَّل على الفرصة. طلب الموافقة أُرسل. التقاط الردود مُعدّ لكن الرد التجريبي لم يُسجَّل؛ التشخيص التالي: صفحة Activity لمسار Inbound في Postmark. التفاصيل في أعلى `docs/AI_HANDOFF.md`.
