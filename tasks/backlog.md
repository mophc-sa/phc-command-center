...
- [ ] تنفيذ الفحوصات الوظيفية + UAT على الإنتاج لـ D1/D2/D5 (بعد نشر migration D5 وEdge Functions المتأثرة في 2026-07-23 — القسمان 3 و6 من قائمة التحقق المحفوظة في Obsidian `1. PROJECTS/PHC/PHC Command Center — Post-Deploy Checklist (Jul 23 2026).md`، تحتاج موافقة صريحة لكتابة بيانات اختبار في CRM حي).
